...
items = [
  ...
  { title: "Lança de Madeira", short_description: "Uma lança feita de madeira.", permalink: "wooden-spear", physical_formula: "2d10 + 2", magical_formula: "0", formula: "2d10 + 2", item_type: ItemType.find_by_permalink('weapon'), bonus_magic_attack: nil, bonus_physical_attack: nil, buy_price: 200, damage_type: DamageType.find_by_title("Perfurante"), sheet_attribute: SheetAttribute.find_by_title("Força"), durability: 2, icon: "GiSpear" },
  ...
  { title: "Picareta de Madeira", short_description: "Uma picareta feita de madeira.", permalink: "wooden-pickaxe", physical_formula: "2d6 + 2", magical_formula: "0", formula: "2d6 + 2", item_type: ItemType.find_by_permalink('weapon'), bonus_magic_attack: nil, bonus_physical_attack: nil, buy_price: 200, damage_type: DamageType.find_by_title("Cortante"), sheet_attribute: SheetAttribute.find_by_title("Força"), durability: 2, icon: "GiPickaxe" },
  { title: "Projéteis de Madeira", short_description: "Projéteis feitos de madeira.", permalink: "wooden-projectiles", physical_formula: "2d4 + 2", magical_formula: "0", formula: "2d4 + 2", item_type: ItemType.find_by_permalink('weapon'), bonus_magic_attack: nil, bonus_physical_attack: nil, buy_price: 50, damage_type: DamageType.find_by_title("Contusivo"), sheet_attribute: SheetAttribute.find_by_title("Força"), durability: 2, icon: "GiProjectile" },
  { title: "Punhal de Madeira", short_description: "Um punhal feito de madeira.", permalink: "wooden-dagger", physical_formula: "2d8 + 2", magical_formula: "0", formula: "2d8 + 2", item_type: ItemType.find_by_permalink('weapon'), bonus_magic_attack: nil, bonus_physical_attack: nil, buy_price: 200, damage_type: DamageType.find_by_title("Cortante"), sheet_attribute: SheetAttribute.find_by_title("Destino"), durability: 2, icon: "GiDagger" },
  { title: "Saxo de Madeira", short_description: "Um saxo feito de madeira.", permalink: "wooden-saxo", physical_formula: "2d10 + 2", magical_formula: "0", formula: "2d10 + 2", item_type: ItemType.find_by_permalink('weapon'), bonus_magic_attack: nil, bonus_physical_attack: nil, buy_price: 200, damage_type: DamageType.find_by_title("Cortante"), sheet_attribute: SheetAttribute.find_by_title("Força"), durability: 2, icon: "GiSaxophone" },
  ...
  { title: "Tábua de Pó de Gema", short_description: "Uma tábua feita de pó de gema mágica.", permalink: "gem-dust-board", physical_formula: "2d4", magical_formula: "2d10 + 2", formula: "2d10 + 2", item_type: ItemType.find_by_permalink('weapon'), bonus_magic_attack: nil, bonus_physical_attack: nil, buy_price: 200, damage_type: DamageType.find_by_title("Mágico"), sheet_attribute: SheetAttribute.find_by_title("Espírito"), durability: 2, icon: "GiMagicPortal" },
  { title: "Bomba Mágica de Pó de Gema", short_description: "Uma bomba mágica feita de pó de gema.", permalink: "gem-dust-magic-bomb", physical_formula: "0", magical_formula: "2d10 + 2", formula: "2d10 + 2", item_type: ItemType.find_by_permalink('weapon'), bonus_magic_attack: nil, bonus_physical_attack: nil, buy_price: 300, damage_type: DamageType.find_by_title("Mágico"), sheet_attribute: SheetAttribute.find_by_title("Intelecto"), durability: 2, icon: "GiMagicBomb" },
  { title: "Cetro de Pó de Gema", short_description: "Um cetro feito de pó de gema mágica.", permalink: "gem-dust-scepter", physical_formula: "2d8", magical_formula: "2d8 + 2", formula: "2d8 + 2", item_type: ItemType.find_by_permalink('weapon'), bonus_magic_attack: nil, bonus_physical_attack: nil, buy_price: 300, damage_type: DamageType.find_by_title("Mágico"), sheet_attribute: SheetAttribute.find_by_title("Intelecto"), durability: 2, icon: "GiScepter" },
  ...
  { title: "Varinha de Pó de Gema", short_description: "Uma varinha feita de pó de gema mágica.", permalink: "gem-dust-wand", physical_formula: "2d4", magical_formula: "2d10 + 2", formula: "2d10 + 2", item_type: ItemType.find_by_permalink('weapon'), bonus_magic_attack: nil, bonus_physical_attack: nil, buy_price: 300, damage_type: DamageType.find_by_title("Mágico"), sheet_attribute: SheetAttribute.find_by_title("Elo Mágico"), durability: 2, icon: "GiMagicWand" },
  ...
  { title: "Urna de Pó de Gema", short_description: "Uma urna feita de pó de gema mágica.", permalink: "gem-dust-urn", physical_formula: "2d4", magical_formula: "2d12 + 2", formula: "2d12 + 2", item_type: ItemType.find_by_permalink('weapon'), bonus_magic_attack: nil, bonus_physical_attack: nil, buy_price: 300, damage_type: DamageType.find_by_title("Mágico"), sheet_attribute: SheetAttribute.find_by_title("Espírito"), durability: 2, icon: "GiUrn" },
